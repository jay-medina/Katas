...
![Object Decomposition Example](./decomposition.png)
...
You have been tasked with writing a new Job Application domain for JobCorpUSA. Requirements for this system are below:
...
* JobCorpUSA should be able to get a report of which jobseekers have applied to jobs on any given day.
* JobCorpUSA should be able to get the job application report in either csv or html format.
* JobCorpUSA should be able to ascertain jobseeker, job, employer and job application date from the job application report.
* JobCorpUSA should be able to see aggregate job application numbers by job and employer.
* JobCorpUSA should be able to see how many job applications failed and how many succeeded aggregated by job and employer.
...
* JobCorpUSA wants the system to be able to handle more than one job with the same title.
* JobCorpUSA wants the system to be able to handle more than one jobseeker with the same name.
* JobCorpUSA wants the system to be able to handle more than one employer with the same name.
